...
class RegisterProfessionalController extends Controller
{
    ...
    public function step1Post(Request $request)
    {
        ...
        $request->validate([
            ...
            'email_professionnel' => 'required|email:strict,filter|unique:professionnel,email_professionnel|max:50',
            ...
            'prenom_professionnel.max'=>"le prenom ne peut pas depasser 50 caracteres",
            'adresse_professionnel.max'=>"l'adresse ne peut pas depasser 50 caracteres",
